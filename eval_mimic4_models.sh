...
# MIMIC-IV Models Evaluation
echo "============================================================================"
echo "Evaluating MIMIC-IV Models on MIMIC-III and MIMIC-IV Datasets"
echo "============================================================================"
echo ""
...
for model_info in "${models[@]}"; do
    ...
    if [ -f "$ckpt_path" ]; then
        python eval.py \
            ...
            --batch-size 64 \
            --seed 42 \
            --output-dir "eval_results/mimic4_models/mimic3_test/$dir_name"
...
for model_info in "${models[@]}"; do
    ...
    if [ -f "$ckpt_path" ]; then
        python eval.py \
            ...
            --batch-size 64 \
            --seed 42 \
            --output-dir "eval_results/mimic4_models/mimic4_test/$dir_name"
...
echo "============================================================================"
echo "MIMIC-IV Models Evaluation Complete!"
echo "Results saved in:"
find "eval_results/mimic4_models" -name "evaluation_report.txt" -type f
echo "============================================================================"
